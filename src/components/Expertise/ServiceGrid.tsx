    ...
    <div className="w-full max-w-[1800px] mx-auto px-4" ref={gridRef}>
      <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
        {services.map((service, index) => {
          ...
          const heightPattern = [
            'h-[400px] md:h-[500px]', // 0: Tall
            'h-[300px] md:h-[350px]', // 1: Short
            'h-[350px] md:h-[450px]', // 2: Medium
            'h-[450px] md:h-[600px]', // 3: Etra Tall
            'h-[300px] md:h-[400px]', // 4: Short
            'h-[380px] md:h-[480px]', // 5: Standard
          ];
