...
export const metadata = {
    title: 'Συχνές Ερωτήσεις | Δωδεκάνησα Glass',
    description: 'Βρείτε απαντήσεις σχετικά με τη διαθεσιμότητα των προϊόντων, τους χρόνους εγκατάστασης και τις εγγυήσεις μας.',
};
